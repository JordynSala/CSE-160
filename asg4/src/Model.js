class Model {
    constructor(glContext, filePath) {
        this.gl = glContext;
    ...
    render() {
        ...
        // UVs set to zeros so shader attribute is valid for this mesh
        ...
        // set uniforms
        const normalDebug = (typeof g_normalOn !== "undefined") && g_normalOn;
        gl.uniform1i(u_whichTexture, normalDebug ? -3 : -2);
